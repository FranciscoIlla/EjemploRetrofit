package francisco.illa.ejemploretrofit.adapters;
...
import francisco.illa.ejemploretrofit.PhotosActivity;
import francisco.illa.ejemploretrofit.R;
...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.AlbumVH> {
    ...
    public class AlbumVH extends RecyclerView.ViewHolder{
        ...
        public AlbumVH(@NonNull View itemView) {
            super(itemView);
            lbTitulo = itemView.findViewById(R.id.lbTituloAlbumViewCard);
        }
    }
}
